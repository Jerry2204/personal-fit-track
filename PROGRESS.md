...
> **Last updated:** 2026-06-12 (Prisma setup completed)
...
- **Status:** Docker PostgreSQL configured — no business features implemented
...
1. Define Prisma schema — MVP entities (User, Profile, Exercise, Workout, …)
2. Run `prisma migrate dev` to create initial migration
